...
- `{id}/index.html` — one page per content node (default Items tab)
- `{id}/tabs/{tabId}/index.html` — extra tab pages for multi-tab type-table hubs only

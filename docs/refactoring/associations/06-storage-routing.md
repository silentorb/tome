...
[`packages/tome-db/src/content/associations-file.ts`](../../../packages/tome-db/src/content/associations-file.ts)

- `compositeTypeForPerspectives(t1, t2)` — sorted slug pair → composite name
- `resolveAssociationId` — lookup by single or pair of perspectives
...
| --- | --- |
| `associations.json` | Registry of composites and perspectives |

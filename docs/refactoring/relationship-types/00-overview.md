...
| **Composite** | A registered bidirectional storage type in `relationship-types.json` with exactly two perspectives. |
...
- Each registered type in `content/model/relationship-types.json` defines `perspectives: [p0, p1]`—one slug projected from each endpoint.
...
- Parser and helpers: [`packages/tome-db/src/content/relationship-types-file.ts`](../../../packages/tome-db/src/content/relationship-types-file.ts).
...
| [`relationship-type-label.ts`](../../../packages/tome-db/src/relationship-type-label.ts) | B7 |
| [`ordered-associations-config/ordered-associations-file.ts`](../../../packages/tome-db/src/ordered-associations-config/ordered-associations-file.ts) | B1, B2 |
...
| --- | --- |
| [`content/model/relationship-types.json`](../../../../marloth-story/content/model/relationship-types.json) | Registered composites, perspectives, optional `perspectiveLabels`. |
...
| [`content/model/ordered-associations.json`](../../../../marloth-story/content/model/ordered-associations.json) | Ordered views; `membershipEdgeType` must be `member_of`. |

Domain values above are from the Marloth corpus; `silentorb-web` has an empty `relationship-types.json` registry.
...
- [Ordered associations](../../features/ordered-associations.md)
